...
export enum Ordering {
  ...
  EQUAL = 0,
  GREATER = 1,
  INCOMPARABLE = NaN, // For partial orders
}
...
export function createClassificationFunctor<E extends OrderedElement>(
  ...
  const actualThresholds = thresholds ?? 
    Array.from({ length: k }, (_, i) => i / (k - 1 || 1));
 ...
 */
export function compareAcrossLattices<
  E1 extends OrderedElement,
  E2 extends OrderedElement
>(
 ...
 */
export interface CrossLatticeMapping<
  E1 extends OrderedElement,
  E2 extends OrderedElement
> {
  source: E1;
 ...
 */
export function findNearestEquivalent<
  E1 extends OrderedElement,
  E2 extends OrderedElement
>(
  sourceLattice: BoundedLattice<E1>,
 ...
 */
export interface LatticeHomomorphism<
  E1 extends OrderedElement,
  E2 extends OrderedElement
> {
  /** Source lattice */
 ...
 */
export function createNearestHomomorphism<
  E1 extends OrderedElement,
  E2 extends OrderedElement
>(
...
export interface GaloisConnection<
  A extends OrderedElement,
  B extends OrderedElement
> {
 ...
 */
export function createGaloisConnection<
  A extends OrderedElement,
  B extends OrderedElement
>(
 ...
 */
export function checkGaloisProperty<
  A extends OrderedElement,
  B extends OrderedElement
>(
...
export class LatticeRegistry {
  ...
  private homomorphisms: Map<string, LatticeHomomorphism<OrderedElement, OrderedElement>> = new Map();
  ...
  registerHomomorphism<E1 extends OrderedElement, E2 extends OrderedElement>(
    ...
    this.homomorphisms.set(key, homomorphism as LatticeHomomorphism<OrderedElement, OrderedElement>);
  }
 ...
 */
export function describeLattice<E extends OrderedElement>(
  lattice: BoundedLattice<E>
): string {
  const lines: string[] = [
...
export function validateLattice<E extends OrderedElement>(
  ...
  for (let i = 1; i < lattice.elements.length; i++) {
    ...
    if (curr.ordinal <= prev.ordinal) {
      errors.push(`Ordinals not strictly increasing: ${prev.name}(${prev.ordinal}) >= ${curr.name}(${curr.ordinal})`);
    }
  }
