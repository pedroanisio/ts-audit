...
// Mathematical Foundations for Cross-Standard Requirements & AI Safety
// Merged from: 01_research_foundations.cypher + complete_graph_v2.cypher
// =============================================================================
...
CREATE (paper_og_rag:Paper {
    ...
    improvement_fact_recall: "+55%",
    improvement_correctness: "+40%"
})
...
CREATE (iec61508:Standard {
    name: "IEC 61508",
    full_name: "Functional Safety of Electrical/Electronic/Programmable Electronic Safety-Related Systems",
...
CREATE (iso26262:Standard {
    name: "ISO 26262",
    full_name: "Road Vehicles — Functional Safety",
    domain: "Automotive",
...
CREATE (ieee29148:Standard {
    name: "IEEE 29148",
    full_name: "Systems and Software Engineering — Life Cycle Processes — Requirements Engineering",
...
CREATE (iso21448:Standard {
    name: "ISO/PAS 21448",
    full_name: "Safety of the Intended Functionality (SOTIF)",
    abbreviation: "SOTIF",
...
CREATE (en50126:Standard {
    name: "EN 50126",
    full_name: "Railway Applications — RAMS Specification and Demonstration",
    domain: "Railway",
...
// NOTE: AchievableCapability AC1-AC6 are defined earlier with proper IDs
// These mechanism/performance details should be merged into those entries
...
CREATE (barrier_relu:TheoreticalBarrier {
    id: "TB8",
...
CREATE (barrier_gnn:TheoreticalBarrier {
    id: "TB9",
...
CREATE (barrier_transformer:TheoreticalBarrier {
    id: "TB10",
...
CREATE (barrier_green_laffont:TheoreticalBarrier {
    id: "TB11",
...
CREATE (barrier_dissolution:TheoreticalBarrier {
    id: "TB12",
...
// =============================================================================
// RESEARCH THREAD T3 - SAFETY STANDARDS RELATIONSHIPS
// =============================================================================

MATCH (t3:ResearchThread {id: "T3"}), (iec:Standard {name: "IEC 61508"})
CREATE (t3)-[:STUDIES {role: "foundational reference standard"}]->(iec);

MATCH (t3:ResearchThread {id: "T3"}), (iso:Standard {name: "ISO 26262"})
CREATE (t3)-[:STUDIES {role: "automotive domain standard"}]->(iso);

MATCH (t3:ResearchThread {id: "T3"}), (do178:Standard {name: "DO-178C"})
CREATE (t3)-[:STUDIES {role: "avionics domain standard"}]->(do178);

MATCH (t3:ResearchThread {id: "T3"}), (iec62304:Standard {name: "IEC 62304"})
CREATE (t3)-[:STUDIES {role: "medical devices standard"}]->(iec62304);

MATCH (t3:ResearchThread {id: "T3"}), (en50126:Standard {name: "EN 50126"})
CREATE (t3)-[:STUDIES {role: "railway domain standard"}]->(en50126);